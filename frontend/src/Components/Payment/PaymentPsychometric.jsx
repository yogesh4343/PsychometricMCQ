...
let filterAssignmentAns = filterAssignment[0];
  ...
  {/* ============================================================ */}
    ...
    <div class="relative col-span-full flex flex-col py-6 pl-8 pr-4 sm:py-12 lg:col-span-4 lg:py-24">
      ...
      <div class="relative">
<div className="cont text-3xl text-pink-600 font-semibold">{filterAssignmentAns.title}</div>
<div className="cont text-3xl text-gray-700 font-semibold">Do Payment Here..</div>
        <div class="my-5 h-0.5 w-full bg-white bg-opacity-30"></div>
        <div class="space-y-2">
          <p class="flex justify-between text-lg font-bold text-white"><span>Total price:</span><span>₹{filterAssignmentAns.price}</span></p>
          <p class="flex justify-between text-sm font-medium text-white"><span>Discount: 50%</span><span>₹{filterAssignmentAns.discount}</span></p>
        </div>
      </div>
      <div class="relative mt-10 text-white">
        <h3 class="mb-5 text-lg font-bold">Support</h3>
        <p class="text-sm font-semibold">+01 12345678900 <span class="font-light">(International)</span></p>
        <p class="mt-1 text-sm font-semibold">vishal@gmail.com <span class="font-light">(Email)</span></p>
...
export default PaymentPsychometric
