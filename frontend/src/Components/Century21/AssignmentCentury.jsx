...
const Assignment = (props) => {
    ...
    const couponButton = () => {
        console.log("Invalid Coupon Entry");
        alert("Invalid Coupon Entry");
    }
    ...
    return (
        <div class="">
            <NavBar />
            <div className=" bg-gradient-to-b from-pink-400  to-orange-400 text-center cursor-pointer md:p-12  w-full m-auto  flex justify-center  gap-5 ">
                <div className="left text-center max-w-[90%] md:max-w-[70%] ">
                    ...
                    <div className="topButtons  gap-4 text-center font-bold py-6   ">
                        <div className="topButon flex gap-4 text-center font-bold justify-center  ">
                            ...
                            {/* <div className="rightButtons w-[12rem] "> <Button  btn="Buy Test" /></div> */}
                        ...
                        {userLoginDetail.status == true ? <NavLink to={`/testCentury/${paramId.id}`}> <div className="bottomButtons w-full md:w-[20rem]  py-4 justify-center  m-auto   "> <Button btn={filterAssignmentAns.title} btn1="Test" /></div>  </NavLink> : <NavLink to={`/login`}> <div className="bottomButtons w-full md:w-[20rem]  py-4 justify-center  m-auto   "> <Button btn={filterAssignmentAns.title} btn1="Test" /></div>  </NavLink>}
                        ...
                        {coupon === true ? <div className="coupon flex gap-2 text-center justify-center  m-auto">
                            ...
                            <Button btn="Apply Coupon" onClick={couponButton} />
